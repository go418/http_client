package dynamic_clientcert_test
...
func TestCloseAll(t *testing.T) {
	...
	dialer := dynamic_clientcert.NewDialer(dialFn)
...
func TestCloseAllRace(t *testing.T) {
	conns := int64(0)
	dialer := dynamic_clientcert.NewDialer(func(ctx context.Context, network, address string) (net.Conn, error) {
